...
module.exports = Reflux.createStore({
	...
	updateList: function(list) {
		root.localStorage && localStorage.setItem(localStorageKey, JSON.stringify(list));
	...
	getInitialState: function() {
		var loadedList = root.localStorage && localStorage.getItem(localStorageKey);
		if (!loadedList) {
